...
class Worker:
    ...
    def _init_from_config(self, client: temporalio.client.Client, config: WorkerConfig):
        ...
        if config["activities"]:
            warn_if_activity_executor_max_workers_is_inconsistent(config)
        ...
        if config["nexus_service_handlers"]:
            warn_if_nexus_task_executor_max_workers_is_inconsistent(config)
...
def warn_if_activity_executor_max_workers_is_inconsistent(config: WorkerConfig) -> None:
...
def warn_if_nexus_task_executor_max_workers_is_inconsistent(
    config: WorkerConfig,
) -> None:
